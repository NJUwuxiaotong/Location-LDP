...
class ImprovedPersonalizedLocationPrivacy(LocationRandomizedGenerator):
    def perturb_location(self, privacy, safe_boundary):
        ...
        for i in range(self.number_of_locations):
            ...
            perturbed_array = self.random_generator(privacy, safe_boundary, block)
            self.perturbed_location_matrix += perturbed_array
